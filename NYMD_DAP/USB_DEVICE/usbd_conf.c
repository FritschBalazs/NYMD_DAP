...
*******************************************************************************/
/* MSP Init. Function copied from an AUTO configured project */
...
/* Function copied from an AUTO configured project */
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  hpcd_USB_OTG_HS.Instance = USB_OTG_HS;   //TODO review USB periph. settings
